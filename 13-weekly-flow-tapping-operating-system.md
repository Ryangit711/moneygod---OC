...
For each "A" setup:
- Write your **trade plan** (entry, stop, target, size based on 1% risk)
- Identify your **invalidation** (what would prove you wrong?)
- Note your **exit plan** (time-based? target hit? trailing?)
- **Do this BEFORE market open Monday** – no ad-hoc trades.

---

## 🕐 DAILY ROUTINE (Market Hours - 9:30 ET to 4:00 ET)
*Your "in-the-trenches" execution system*

### 🌅 Pre-Market (7:00-9:30 ET)
1. **Check overnight gaps** in your watchlist (ES, CL, GC, USD/CAD, etc.)
2. **Review economic calendar** for today's events
3. **Verify your "A" setups** are still valid based on overnight action

### 📉 During Market Hours
- **Only trade your pre-marked "A" setups** – no exceptions
- **If no setup triggers**, do nothing. Preserve capital.
- **After each trade** (win or loss):
  1. Immediately calculate profit/loss in CAD
  2. **Allocate per Section 3 below** (minimum 50% to compound account)
  3. Update your trade journal: entry, exit, reason, P&L, allocation

### 🌇 Post-Market (4:00-5:00 ET)
1. **Review all trades**: Did you follow your plan?
2. **Update journal** with screenshots and lessons
3. **Check for weekly signals** (COT report Fridays at 3:30 ET)
4. **Prepare watchlist for tomorrow**

---

## 💰 PROFIT ALLOCATION RULES (Non-Negotiable)
*Every time you close a trade, immediately split the profit:*

| Amount | Action | Purpose |
|--------|--------|---------|
| **First 50%** | → **Compound Account** (TFSA first, then RRSP/FHSA) | Wealth multiplication |
| **Next 30%** | → **Trading Account Growth** | Increase position size over time |
| **Remaining 20%** | → **Lifestyle Buffer** | Reward discipline (optional) |

> 🚫 **NEVER** violate this sequence. If you have a losing trade, allocate $0 – the rule only applies to profits.

### Where to Put the 50% (in order of priority):
1. **TFSA** – Max $7,000/year (2025) – **ALL growth tax-free forever**
   - Invest in: VFV (S&P 500 CAD-hedged) or XEQT (global all-equity)
2. **RRSP** – If you need tax deduction – growth tax-deferred
   - Same investments as TFSA
3. **FHSA** – If saving for first home – best of both worlds
4. **Margin Account** – Only after tax-advantaged accounts are full
...
### 💰 **2. "If I take this profit, where will it go to multiply?"** 
*(Respect the allocation – Section 3 above)*
- If the answer isn't "mostly to my compound account," **do not take the trade**. 
- Wait for a setup where you'll honor the allocation.

---

## 📊 MONTHLY REVIEW (First Sunday of Month - 60 min)
*Your strategic adjustment session*

### 1. **Performance Audit**
- Calculate: Net trading profit/loss for the month
- Calculate: Amount allocated to compound account
- Review: Win rate, average R:R, largest win/loss
...
### 3. **Account Audit**
- Check: TFSA/RRSP/FHSA balances and allocations
- Rebalance: If any asset class >20% of portfolio
- Contribute: Catch up on any room (use trading profits!)

### 4. **Strategy Refinement**
- Read: One new section from your wiki (e.g., deepen COT understanding)
- Test: One small tweak to your setup criteria (paper trade first)
- Archive: Screenshots of your best/worst trades for learning

---

## 📈 COMPOUNDING PROJECTION (Based on Your Efforts)
*See how flow-tapping builds real wealth*

Assume:
- Starting capital: $10,000
- Monthly trading profit: $2,000 (conservative for skilled flow-tapper)
- 50% of profits → compound account ($1,000/month)
- Compound account return: 7% annually (conservative equity market return)

| Time | Trading Profits (Cumulative) | Compound Account Value | **Total Wealth** |
|------|------------------------------|------------------------|------------------|
| 6 mos | $12,000 | $6,200 | **$18,200** |
| 1 yr | $24,000 | $14,800 | **$38,800** |
| 2 yrs | $48,000 | $34,200 | **$82,200** |
| 3 yrs | $72,000 | $58,200 | **$130,200** |
| 4 yrs | $96,000 | $87,500 | **$183,500** |
| 5 yrs | $120,000 | $122,800 | **$242,800** |

**At Year 5**: You've converted $120k of trading flow into $243k total wealth – **$123k came from compounding alone**.

> 💡 **The Multiplier Effect**: As your trading skill improves (higher win rate, better R:R), your monthly profit grows. At $3k/month profit → $364k total at 5 years. At $5k/month → $606k total.
...
7. **2 losses in a row = 30-min break** – 3 losses = stop for the day
8. **Execute the pre-market plan only** – zero ad-hoc trades
9. **Journal every trade** – no exceptions, not even winners
10. **When it looks too good, cut size in half** – when it looks ugly and everyone's against you, that's often the real entry
...
☐ **Monday 8:00 ET**: Complete Weekly Routine (Sections 1-3 above)  
☐ **Daily 7:00 ET**: Pre-Market Check  
☐ **Market Hours**: Trade Only Your "A" Setups  
☐ **Daily 4:30 ET**: Post-Market Review  
☐ **Every Trade**: Immediately Allocate Profits (50/30/20)  
☐ **First Sunday**: Monthly Review  

**Check these boxes. Keep them checked. Watch your freedom compound.**
...
**This file (13-weekly-flow-tapping-operating-system.md) is your weekly execution checklist.**  
Print it. Save it on your phone. Do the work. Watch the flow turn into freedom.

> 💎 **Remember**: You're not trying to predict the future.  
> You're learning to **read the pressure gauges on the monetary pipes**—  
> then **open your valve at the exact moment the flow is strongest**—  
> and **relentlessly sending that captured flow into compounding assets**  
> so it makes more flow for you, while you sleep.  
>   
> Now go read the plumbing, tap the flow, and compound your escape.
